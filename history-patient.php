...
if (isset($_POST["show"])) {
  if ($_POST["filename"] !== "") {
    ...
    $cfilen = "reports/" . $filen . ".txt";
    if (file_exists($cfilen)) {
      $fc = file_get_contents($cfilen);
    } else {
      echo '<div class="alert  alert-danger alert-dismissible fade show" role="alert">
      <strong>Sorry! </strong> But File Not Found.....Please Check Your File Name And Try Again...
    ...
    echo '<div class="alert  alert-danger alert-dismissible fade show" role="alert">
      <strong>Oh No! </strong>Please Provide Valid patient File Name......It Can\' Be Empty...... 
      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>';
...
<head>
  ...
  <link rel="stylesheet" href="history-patient.css" media="screen">
  ...
  <meta property="og:title" content="history-patient">
...
<body class="u-body">
  ...
  <section class="u-clearfix u-image u-shading u-valign-middle-sm u-section-1" id="sec-af61" data-image-width="1280" data-image-height="854">
              ...
              <div class="u-align-center-lg u-align-center-md u-align-center-xl u-align-right-sm u-align-right-xs u-form u-form-1">
                <form action="" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-11 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 3px;" redirect="true">
                  <div class="u-form-group u-form-group-1">
                    ...
                    <input type="text" placeholder="Enter File Name" id="text-8350" name="filename" value="<?php echo $filen; ?>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
                  </div>
                  <div class="u-form-group u-form-message">
                    <label for="message-b832" class="u-form-control-hidden u-label"></label>
                    <textarea disabled placeholder="medical history will show here" rows="15" cols="50" id="message-b832" name="message" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""><?php echo $fc; ?></textarea>
                  </div>
                  <div class="u-align-center u-form-group u-form-submit">
                    <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-custom-color-1 u-btn-7">show History<br>
                    </a>
                    <input type="submit" value="submit" name="show" class="u-form-control-hidden">
                  </div>
